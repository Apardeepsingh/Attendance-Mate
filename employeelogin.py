...
class Main:
    def __init__(self):
        ...
        self.mainLabel = Label(self.root, text="Employee Login", font=('calibri', 28, 'bold'),bg="#2FA572",fg="white", borderwidth=3,relief=RAISED)
        ...
        self.btn = Button(self.root, text='Submit', font=font, command=self.verifyEmployee, borderwidth=3,relief=GROOVE,activebackground="#2FA572",activeforeground="#fff")
    ...
    def verifyEmployee(self):
        ...
        q = f"select * from employee where email='{email}' and password='{password}'"
        ...
        if len(data) == 0:
            ...
            self.root.destroy()
            employee_dashboard.Main(data[0][0])
